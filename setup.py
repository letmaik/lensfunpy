...
# $ nosetests --with-coverage --cover-xml --cover-package=lensfunpy
# $ cython --annotate-coverage coverage.xml _lensfun.pyx
# A _lensfun.html file is generated by cython showing Python-level coverage.
compdirectives = {}
macros = []
