"""
Test that the .pyi stub file matches the runtime signatures of the _lensfun module.
...
Note: This test requires the lensfunpy module to be built and installed/importable.
"""
...
def test_stub_matches_runtime():
    """
    Use mypy stubtest to verify that lensfunpy/_lensfun.pyi matches the runtime signatures.
    ...
    # Run stubtest on the _lensfun module with allowlist
    # The stub file lensfunpy/_lensfun.pyi will be automatically found by mypy
    ...
    result = subprocess.run(
        [sys.executable, "-m", "mypy.stubtest", "lensfunpy._lensfun", 
    ...
    if result.returncode != 0:
        error_msg = f"""
Stub file (lensfunpy/_lensfun.pyi) does not match runtime signatures!
...
To fix this, update lensfunpy/_lensfun.pyi to match the runtime signatures.
To run stubtest manually: python -m mypy.stubtest lensfunpy._lensfun
"""
